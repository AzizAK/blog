...
description: عندما يقوم المبرمج بكتابة برنامج من دون اتباع معايير معيينه ينتج عن ذلك تصميم سيء للبرنامج مما يؤدي الى برنامج غير قابل للتوسع ومليء بالاخطاء البرمجية عند قيامك بأي تعديل لاحقاً، ولكن عندما تقوم ببرمجة وفقاً لهذه المبادئ سيكون لديك برنامج أبسط في الفهم لك وللمبرمجين الآخرين، أسهل في الصيانة، وقابل للتوسع.
category: برمجة
tags:
  - برمجة
  - تقنية
...
عندما يقوم المبرمج بكتابة برنامج من دون اتباع معايير معيينه ينتج عن ذلك تصميم سيء للبرنامج مما يؤدي الى برنامج غير قابل للتوسع ومليء بالاخطاء البرمجية عند قيامك بأي تعديل لاحقاً، ولكن عندما تقوم ببرمجة وفقاً لهذه المبادئ سيكون لديك برنامج أبسط في الفهم لك وللمبرمجين الآخرين، أسهل في الصيانة، وقابل للتوسع. وسنعرف الان كيف يكون تطبيق هذه المبادئ يساعد في تحقيق ماذكر. مع أمثلة تطبيقية لذلك بإستخدام لغة #C لكنها تنبطق على أي لغة Object Oriented.
...
الحل؟
نقوم بفصل الـInterface الى ثلاث أقسام تابع المثال
...
ستبدو هذه المبادئ الخمسة صعبة التطبيق في البداية لكن من خلال الممارسة ستعتاد ومن خلال تطبيقها ستحصد ثمارها في حال كبر حجم البرنامج لديك لانه سيكون قابل لإعادة الاستخدام وقابل للصيانة وقابل للاختبار بسهولة.
